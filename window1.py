...
from move_window import Ui_Dialog2
from writeoff_window import Ui_Dialog3
from add_delivery_window import Ui_Dialog4
from add_update_warehouse import Ui_Dialog5
from delivery_cont_win import Ui_Dialog6

class Ui_Dialog(object):
    def setupUi(self, Dialog):

        Dialog.setObjectName("Dialog")
        Dialog.resize(884, 585)
        ...
        self.sklad.setGeometry(QtCore.QRect(0, 0, 891, 601))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 110, 861, 411))
        ...
        self.pushButton_18 = QtWidgets.QPushButton(self.Sklad)
        self.pushButton_18.setGeometry(QtCore.QRect(10, 530, 201, 28))
        self.pushButton_18.setObjectName("pushButton_18")
        self.pushButton_19 = QtWidgets.QPushButton(self.Sklad)
        self.pushButton_19.setGeometry(QtCore.QRect(220, 530, 201, 28))
        self.pushButton_19.setObjectName("pushButton_19")
        self.pushButton_20 = QtWidgets.QPushButton(self.Sklad)
        self.pushButton_20.setGeometry(QtCore.QRect(670, 530, 201, 28))
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(10, 110, 861, 411))
        ...
        self.pushButton_14.setGeometry(QtCore.QRect(10, 530, 201, 28))
        self.pushButton_14.setObjectName("pushButton_14")
        self.pushButton_17 = QtWidgets.QPushButton(self.tab)
        self.pushButton_17.setGeometry(QtCore.QRect(670, 530, 201, 28))
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(680, 530, 191, 28))
        self.pushButton_10.setObjectName("pushButton_10")
        self.tableWidget_7 = QtWidgets.QTableWidget(self.Tab3)
        self.tableWidget_7.setGeometry(QtCore.QRect(10, 30, 861, 491))
        ...
        self.pushButton_11.setGeometry(QtCore.QRect(10, 530, 201, 28))
        self.pushButton_11.setObjectName("pushButton_11")
        self.pushButton_12 = QtWidgets.QPushButton(self.Tab3)
        self.pushButton_12.setGeometry(QtCore.QRect(220, 530, 201, 28))
        self.pushButton_12.setObjectName("pushButton_12")
        self.sklad.addTab(self.Tab3, "")
        self.retranslateUi(Dialog)
        self.sklad.setCurrentIndex(0)
        ...
        supplies=workBD.get_info_deliveryes_all_warehouse()
        self.table_filling(supplies,self.tableWidget_3,[],[3])
        ...
        self.table_filling(warehouses,self.tableWidget_7,[4,5],[])
        self.tableWidget_7.horizontalHeader().sectionClicked.connect(lambda: self.sort_table(self.tableWidget_7))
        self.tableWidget_7.verticalHeader().sectionClicked.connect(self.search_warehoyses)

        self.tableWidget_7.itemDoubleClicked.connect(lambda: self.open_add_update_warehouse(
            self.tableWidget_7.item(self.tableWidget_7.currentRow(),0).text(),
            self.tableWidget_7.item(self.tableWidget_7.currentRow(),1).text(),
            self.tableWidget_7.item(self.tableWidget_7.currentRow(),2).text(),
            float(self.tableWidget_7.item(self.tableWidget_7.currentRow(),3).text()),
            float(self.tableWidget_7.item(self.tableWidget_7.currentRow(),4).text()),False))

        self.tableWidget_3.itemDoubleClicked.connect(self.delivery_consist)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_18.setText(_translate("Dialog", "Переместить"))
        self.pushButton_19.setText(_translate("Dialog", "Списать"))
        self.pushButton_20.setText(_translate("Dialog", "Обновить таблицу"))
        ...
        self.pushButton_14.setText(_translate("Dialog", "Добавить поставку"))
        self.pushButton_17.setText(_translate("Dialog", "Обновить таблицу"))
        self.sklad.setTabText(self.sklad.indexOf(self.tab), _translate("Dialog", "Поставки"))
        self.label_10.setText(_translate("Dialog", "Список складов:"))
        ...
        self.pushButton_11.setText(_translate("Dialog", "Добавить склад"))
        self.pushButton_12.setText(_translate("Dialog", "Удалить склад"))
        self.sklad.setTabText(self.sklad.indexOf(self.Tab3), _translate("Dialog", "Склад"))
        ...
        self.pushButton_18.clicked.connect(self.open_move)
        self.pushButton_19.clicked.connect(self.open_writeoff)
        self.pushButton_20.clicked.connect(lambda :self.download_products_or_deliverys(self.tableWidget, self.comboBox, self.table_filling,
                                                                                       workBD.get_products_from_warehouse(
                                                                     self.comboBox.currentText()),
                                                                                       workBD.get_products_from_all_warehouse(), [4,5], [6,7]))
        ...
        self.pushButton_17.clicked.connect(lambda: self.download_products_or_deliverys(self.tableWidget_3, self.comboBox_2, self.table_filling,
                                                                                       workBD.get_info_deliveryes_on_warehoouse(
                                                                    self.comboBox_2.currentText()),
                                                                                       workBD.get_info_deliveryes_all_warehouse(), [], [3]))


        self.pushButton_10.clicked.connect(lambda :self.download(self.tableWidget_7,self.table_filling,workBD.get_warehouses_info(),[4,5],[]))
        self.pushButton_14.clicked.connect(self.open_add_delivery)
        self.pushButton_11.clicked.connect(lambda :self.open_add_update_warehouse("","","",0,0,True))
        self.pushButton_12.clicked.connect(self.del_warehouse)
    @staticmethod
    ...
    def search_warehoyses(self,e):
        if self.tableWidget_7.verticalHeaderItem(e).text() == "Найти":
           try:
                data=workBD.search_warehouse(warehouse_name=self.tableWidget_7.item(0,0),
                                       address=self.tableWidget_7.item(0,1),
                                       text_location=self.tableWidget_7.item(0,2),
                                       latitude=self.tableWidget_7.item(0,3),
                                       longitude=self.tableWidget_7.item(0,4))

                if data == []:
                    self.warning_message()
                else:
                    self.table_filling(data, self.tableWidget_7, [4,5], [])
           except:
               self.warning_message()
    ...
    def del_warehouse(self):
        ...
        confirmation.setText("Вы дейстаительно хотите удалить данный склад?")
        confirmation.setStandardButtons(QMessageBox.Cancel|QMessageBox.Ok)
        confirmation.setDefaultButton(QMessageBox.Cancel)

        confirmation.buttonClicked.connect(self.yes_del)
        if self.tableWidget_7.currentIndex().isValid() !=False:
            confirmation.exec_()
    def yes_del(self,btn):
        if btn.text()=="OK":
            workBD.del_record("warehouse",id=self.tableWidget_7.verticalHeaderItem(self.tableWidget_7.currentRow()).text().replace("№",""))
    ...
    def open_add_update_warehouse(self,warehouse_name:str,address:str,location:str,longitude,latitude,this_add:bool):
        Dialog = QtWidgets.QDialog()
        ui = Ui_Dialog5()
        ui.setupUi(Dialog)
        ui.lineEdit.setText(warehouse_name)
        ui.lineEdit_2.setText(address)
        ui.lineEdit_3.setText(location)
        ui.doubleSpinBox.setValue(longitude)
        ui.doubleSpinBox_2.setValue(latitude)
        ui.this_add=this_add
        ui.number=self.tableWidget_7.verticalHeaderItem(self.tableWidget_7.currentRow()).text().replace("№","")
        Dialog.show()
        Dialog.exec_()

    def delivery_consist(self):
        Dialog = QtWidgets.QDialog()
        ui = Ui_Dialog6()
        ui.number = self.tableWidget_3.verticalHeaderItem(self.tableWidget_3.currentRow()).text().replace("№", "")
        ui.characteristics=[self.tableWidget_3.verticalHeaderItem(self.tableWidget_3.currentRow()).text(),self.tableWidget_3.item(self.tableWidget_3.currentRow(),0).text(),self.tableWidget_3.item(self.tableWidget_3.currentRow(),1).text(),self.tableWidget_3.item(self.tableWidget_3.currentRow(),2).text()]
        ui.setupUi(Dialog)
        Dialog.show()
        Dialog.exec_()
